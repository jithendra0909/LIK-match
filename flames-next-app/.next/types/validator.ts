...
// Validate ../../src/app/api/check-flames/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/check-flames">> = Specific
  const handler = {} as typeof import("../../src/app/api/check-flames/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
